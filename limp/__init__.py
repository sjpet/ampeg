# -*- coding: utf-8 -*-
"""Limp provides a few simple tools for parallel computing, wrapping gently
around the multiprocessing module.

Computation graphs
------------------

The core data structure for limp is the computation graph, a directed acyclic
...
...             3: (lambda x, y: x + y,
...                 (limp.Dependency(0, None, 1),
...                  limp.Dependency(1, None, 1)),
...                 10.7),
...             4: (lambda x, y: x*y,
...                 (limp.Dependency(0, None, 1),
...                  limp.Dependency(2, None, 1)),
...                 10.8),
...             5: (lambda x, y: x - y,
...                 (limp.Dependency(3, None, 1),
...                  limp.Dependency(4, None, 1)),
...                 10.9)}
>>> task_lists, task_ids = \\
...     limp.earliest_finish_time(my_graph, n_processes)
